...
class MeditationExerciseProvider extends ChangeNotifier {
  List<MeditationExerciseModel> _allMeditationExercises = []; // All
  List<MeditationExerciseModel> meditationExercises = []; // If any changes use this

  // Constructor
  MeditationExerciseProvider() {
    // initialise the default meditation exercises
    ...
    // copy _allMeditationExercises to meditationExercises list

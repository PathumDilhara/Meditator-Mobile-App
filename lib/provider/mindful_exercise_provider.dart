...
class MindfulnessExerciseProvider extends ChangeNotifier {
  List<MindfulnessExerciseModel> _allMindfulnessExercises = []; // All
  List<MindfulnessExerciseModel> mindfulnessExercise =
      []; // If any changes use this

  // Constructor
  MindfulnessExerciseProvider() {
    // Initialise the all Mindful exercise to _allMindfulExercises list and to mindful exercise list
    _allMindfulnessExercises = [
    ...
    // copy _allMindfulExercises to mindfulExercise list

    // In this case, mindfulnessExercise is created as a new list that contains
    // the elements of _allMindfulnessExercises. This is a shallow copy, meaning
    // that the new list contains the same elements as the original, but it is a
    // separate object. Changes made to mindfulnessExercise will not affect
    // _allMindfulnessExercises.

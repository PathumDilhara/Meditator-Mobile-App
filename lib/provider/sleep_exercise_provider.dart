...
class SleepExerciseProvider extends ChangeNotifier {
  List<SleepExerciseModel> _allSleepExercises = []; // All
  List<SleepExerciseModel> sleepExercises = []; // If any changes use this

  // Constructor
  SleepExerciseProvider() {
    // initialise the default sleep exercises
    _allSleepExercises = [
      SleepExerciseModel(
    ...
    // Copy _allSleepExercises to sleepExercises
